...
export default async function handler(req, res) {
  ...
  try {
    ...
    if(!data){
      try{ const gh=await readRepoJson(PRODUCTS_PATH); data=gh.data; sha=gh.sha; source="github"; }catch(e){ console.warn("Products GitHub unavailable; trying asset:",e?.message||e); data=await readJsonAsset(PRODUCTS_PATH); source="asset"; }
