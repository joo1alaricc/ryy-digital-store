...
import { notifyAllNewOrder } from "../gateway-registry.js";
...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Every enabled gateway receives the same proof image, but each uses its own owner number.
        notifyAllNewOrder({purchase:pending,user}).catch(e=>console.error("WA new order notify:",e));
